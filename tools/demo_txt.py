...
def parse_args():
    ...
    parser.add_argument('--image_dir', type=str, default='/home/yuyong/data/typeB/streetview2/')
    parser.add_argument('--image_save', type=str, default='/home/yuyong/data/typeB/pred_streetview2/')
    parser.add_argument('--result_txt', type=str, default='/home/yuyong/data/typeB/streetview2_results.txt')
...
def det_bboxes(img,
    ...
    for bbox, label in zip(bboxes, labels):
        ...
        ss = ' '+str(left_top[0])+','+str(left_top[1])+','+str(right_bottom[0])+','+str(right_bottom[1])+','+label_text
        if len(bbox) > 4:
